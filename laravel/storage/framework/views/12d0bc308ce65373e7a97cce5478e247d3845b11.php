...
<button type='button' onclick="send()">留言</button>
	<table border="1" cellpadding="5" cellspacing="0">
			...
			<tr>
				<td><?php echo e(isset($v->id) ? $v->id : ""); ?></td>
				<td><?php echo e(isset($v->name) ? $v->name : 'php'); ?></td>
				<td><?php echo e(isset($v->content) ? $v->content : "最好的语言"); ?></td>
				<td><?php echo e(isset($v->time) ? $v->time : 000); ?></td>
				<td colspan="5">
					<a href="javascript:delMessage(<?php echo e($v->id); ?>);">删除</a>
					<a href="javascript:modifyMessage(<?php echo e($v->id); ?>);">修改</a>
				</td>
			</tr>
		...
		<div   style="margin-left:550px;"><?php echo $info->render(); ?></div>
</center>
</body>
</html>
<!-- 添加留言的模板 -->
